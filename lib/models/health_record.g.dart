...
extension HealthRecordQuerySortBy
  ...
  QueryBuilder<HealthRecord, HealthRecord, QAfterSortBy> sortByGoatId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'goatId', Sort.asc);
    });
  }

  QueryBuilder<HealthRecord, HealthRecord, QAfterSortBy> sortByGoatIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension HealthRecordQuerySortThenBy
  ...
  QueryBuilder<HealthRecord, HealthRecord, QAfterSortBy> thenByGoatId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'goatId', Sort.asc);
    });
  }

  QueryBuilder<HealthRecord, HealthRecord, QAfterSortBy> thenByGoatIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'goatId', Sort.desc);
    });
  }
...
extension HealthRecordQueryWhereDistinct
  ...
  QueryBuilder<HealthRecord, HealthRecord, QDistinct> distinctByGoatId() {
    return QueryBuilder.apply(this, (query) {
