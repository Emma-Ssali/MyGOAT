...
const FinancialTransactionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'linkedGoatTagId': PropertySchema(
      id: 6,
      name: r'linkedGoatTagId',
      type: IsarType.string,
    )
  },
...
int _financialTransactionEstimateSize(
  ...
  {
    final value = object.linkedGoatTagId;
    if (value != null) {
...
void _financialTransactionSerialize(
  ...
  writer.writeString(offsets[6], object.linkedGoatTagId);
}
...
FinancialTransaction _financialTransactionDeserialize(
  ...
  object.linkedGoatTagId = reader.readStringOrNull(offsets[6]);
  return object;
}
...
extension FinancialTransactionQueryFilter on QueryBuilder<FinancialTransaction,
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction,
      QAfterFilterCondition> linkedGoatTagIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'linkedGoatTagId',
      ));
    });
  }

  QueryBuilder<FinancialTransaction, FinancialTransaction,
      QAfterFilterCondition> linkedGoatTagIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'linkedGoatTagId',
      ));
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction,
      QAfterFilterCondition> linkedGoatTagIdEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction,
      QAfterFilterCondition> linkedGoatTagIdGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction,
      QAfterFilterCondition> linkedGoatTagIdLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction,
      QAfterFilterCondition> linkedGoatTagIdBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction,
      QAfterFilterCondition> linkedGoatTagIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction,
      QAfterFilterCondition> linkedGoatTagIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction,
          QAfterFilterCondition>
      linkedGoatTagIdContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'linkedGoatTagId',
        value: value,
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction,
          QAfterFilterCondition>
      linkedGoatTagIdMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'linkedGoatTagId',
        wildcard: pattern,
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction,
      QAfterFilterCondition> linkedGoatTagIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'linkedGoatTagId',
        value: '',
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction,
      QAfterFilterCondition> linkedGoatTagIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'linkedGoatTagId',
        value: '',
...
extension FinancialTransactionQuerySortBy
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction, QAfterSortBy>
      sortByLinkedGoatTagId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'linkedGoatTagId', Sort.asc);
    });
  }

  QueryBuilder<FinancialTransaction, FinancialTransaction, QAfterSortBy>
      sortByLinkedGoatTagIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'linkedGoatTagId', Sort.desc);
    });
  }
}
...
extension FinancialTransactionQueryWhereDistinct
  ...
  QueryBuilder<FinancialTransaction, FinancialTransaction, QDistinct>
      distinctByLinkedGoatTagId({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'linkedGoatTagId',
          caseSensitive: caseSensitive);
    });
  }
}
...
extension FinancialTransactionQueryProperty on QueryBuilder<
  ...
  QueryBuilder<FinancialTransaction, String?, QQueryOperations>
      linkedGoatTagIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'linkedGoatTagId');
    });
  }
}
